...
class GridManager():
    ...
    def update_grid_geometry(self, property_name, scalar=20, slice_x=None, slice_y=None, token=None, step=0):
        print('update_grid_geometry', property_name)
        ...
        try:
            ...
            prop_data = self.api.get_dynamic_props(token, property_name, step)
            prop_data.reverse()

            prop_data_normalize = [
                prop_data.pop() if i and prop_data else None for i in actnum_base
            ]
